...
#comp is the biggest connected component in the original graph 'g'
comp<-connected.comp.list[[i]]
png("X:\\experiment\\multi_level_model_for_social_network\\result\\rand_sample_01\\communities_by_followers.png", type="cairo", units="in", width=10, height=10, res=300)
...
par(mar=c(0,0,0,0))
png("X:\\experiment\\multi_level_model_for_social_network\\result\\rand_sample_01\\communities_by_followers_abs_3rd.png", type="cairo", units="in", width=10, height=10, res=300)
